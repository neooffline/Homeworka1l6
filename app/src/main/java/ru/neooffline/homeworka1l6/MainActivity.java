...
public class MainActivity extends AppCompatActivity {
    ...
    public void goToSecond(View view) {
        ...
        chekes();
        for (int i = 0; i < this.getResources().getStringArray(R.array.parameters).length; i++) {
    ...
    private void chekes() {
        booleans = new boolean[this.getResources().getStringArray(R.array.parameters).length];
        for (int i = 0; i < this.getResources().getStringArray(R.array.parameters).length; i++) {
    ...
    private void setCheckBoxies() {
        allCheckBoxies = new CheckBox[this.getResources().getStringArray(R.array.parameters).length];
